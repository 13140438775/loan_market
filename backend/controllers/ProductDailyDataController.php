...
use backend\models\ProductDailyDataSearch;
 ...
 */
class ProductDailyDataController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new ProductDailyDataSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $apps = Apps::getIdNameMap();
    ...
    /**
     * Displays a single ProductDailyData model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new ProductDailyData model.
    ...
    /**
     * Updates an existing ProductDailyData model.
    ...
    /**
     * Deletes an existing ProductDailyData model.
