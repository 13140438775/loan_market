...
$this->title = '修改账户渠道 '. $model->username;
...
<div class="channel-account-create">
    ...
    <div class="common-form-container">
        <form class="common-form" action="<?= \yii\helpers\Url::toRoute(['channel-account/do-channel-assoc-account']) ?>" method="post" enctype="multipart/form-data">
            <input name="_csrf-backend" type="hidden" id="_csrf" value="<?= Yii::$app->request->csrfToken ?>">

            <input type="text" class="form-control" name="id" placeholder="用户名" aria-label="username" aria-describedby="basic-addon1" value="<?= $model->id ?>" style="display: none">

            <input type="text" class="form-control" name="username" placeholder="用户名" aria-label="username" aria-describedby="basic-addon1" value="<?= $model->username ?>" style="display: none">

            <input type="password" class="form-control" name="password" placeholder="密码" aria-label="username" aria-describedby="basic-addon1" value="<?= $model->password ?>" style="display: none">

            <input type="text" class="form-control" name="mobile" placeholder="手机号" aria-label="username" aria-describedby="basic-addon1" value="<?= $model->mobile ?>" style="display: none">
